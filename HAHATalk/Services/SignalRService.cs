...
namespace HAHATalk.Services
{
    ...
    public class SignalRService : ISignalRService
    {
        ...
        public SignalRService(UserStore userStore)
        {
            ...
            // 서버로부터 메시지 수신 리스너 등록 
            // 서버 Hub에서 Clients.User(target).SendAsync("ReceiveMessage", sender, msg) 호출 시 작동
            _connection.On<string, string>("ReceiveMessage", (senderEmail, message) =>
            {
            ...
            {
                System.Diagnostics.Debug.WriteLine("Signal R Reconnected!");
